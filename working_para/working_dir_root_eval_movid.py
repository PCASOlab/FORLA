...
Dataset_video_pkl_MOVIE = working_pcaso_raid + "MOVi/MOVi-E/pkl/test/"
Dataset_video_pkl_MOVID = working_pcaso_raid + "MOVi/MOVi-D/pkl/test/"

data_flag_list = ["Cholec_data_flag", "Thoracic_data_flag", "MICCAI_data", "MICCAI_data_merge","MICCAIv2",
                  "Endovis_data","DAVIS","YTVOS","YTOBJ","MOVIE","MOVID"]
selected_data= ["MOVID"]
