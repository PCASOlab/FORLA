...
class myDataloader(object):
    def __init__(self, OLG=False,img_size = 128,Display_loading_video = False,
                 Read_from_pkl= True,Save_pkl = False,Load_flow =False,Load_feature=True,Train_list = "else",starting_percentage=0.0,Device=device):
                ...
                if ( (dataset_source == 'miccai' and (clip_name in self.all_labels)) or Valid_video_flag==True):  
                    ...
                    if dataset_source == "ytvos":
                        ...
                        if Evaluation_slots == True:
                            ...
                            mask = format_convertor.color_mask_to_instance_mask_ytvos(self.this_masks)
                            self.this_label_mask = mask 
                        self.this_video_label = binary_vector
                        self.this_frame_label = labels
                    ...
                    if dataset_source == 'cholec' or dataset_source == 'thoracic' or dataset_source == 'endovis' or dataset_source == 'ytvos' or  dataset_source == 'ytobj':
