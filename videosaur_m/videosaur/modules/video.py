...
from videosaur_m.videosaur.utils import make_build_fn
...
def Map_time_w_modules(*args,module1,module2,epoch=None,read_id=None,Output_root=None):
        batch_size = None
        seq_len = None
        flattened_args = []
        ...
        outputs = module1(*flattened_args,epoch=epoch,read_id=read_id,Output_root=Output_root)
        ...
        return unflattened_outputs
def Map_time_feature_stack(*args,module1,epoch=None,batch_files =None,Output_root=None):
        batch_size = None
        seq_len = None
        flattened_args = []
        ...
        outputs = module1(*flattened_args,epoch=epoch,batch_files =batch_files ,Output_root=Output_root)
        

        return outputs
def Map_time_adapt_reshape(*args,outputs,module2):
        batch_size = None
        seq_len = None
        flattened_args = []
