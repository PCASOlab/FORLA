...
DEFAULT_CONFIG = "videosaur_m/configs/videosaur/ytvis3_MLP786.yml"
...
Model_infer = model_infer_slot_att._Model_infer(parser.parse_args(),GPU_mode,num_gpus,slot_ini="random",Foundation_M="CLIP",gpu_selection=Gpu_selection,pooling="max",TPC=True)
