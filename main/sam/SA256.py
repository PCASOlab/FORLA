...
Output_root = Output_root + "sam_SA/"
# GPU_mode= True
# Continue_flag = True
# Visdom_flag = False
# Display_flag = False
...
DEFAULT_CONFIG = "videosaur_m/configs/videosaur/ytvis3_MLP256.yml"
...
Model_infer = model_infer_slot_att._Model_infer(parser.parse_args(),GPU_mode,num_gpus,slot_ini="random",Foundation_M="SAM",gpu_selection=Gpu_selection,pooling="max",TPC=True)
