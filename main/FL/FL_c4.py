...
Model_infer = model_infer_slot_att._Model_infer(parser.parse_args(),parser_s.parse_args(),GPU_mode,num_gpus,slot_ini="rnn",Foundation_M="ensemble",foundation_list  = ["DINO","SAM","MAE","CLIP"],fusion_method='moe_layer',gpu_selection=Gpu_selection,TPC=True)
...
# Model.cuda()
dataLoader = myDataloader(img_size = img_size,Display_loading_video = False,Read_from_pkl= True,Save_pkl = False,Load_flow=Load_flow, Load_feature=Load_feature,Train_list='else',starting_percentage=0.3,Device=device)
