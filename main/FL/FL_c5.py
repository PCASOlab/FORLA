...
CLIENT_ID = 5
DEFAULT_CONFIG = "videosaur_m/configs/videosaur/ytvis3_MLP_en_6.yml"
DEFAULT_CONFIG_s = "videosaur_m/configs/videosaur/ytvis3_MLP_en_s_6.yml"
...
Model_infer = model_infer_slot_att._Model_infer(parser.parse_args(),parser_s.parse_args(),GPU_mode,num_gpus,slot_ini="random",Foundation_M="ensemble",foundation_list  = ["DINO","SAM","MAE","CLIP"],fusion_method='moe_layer',gpu_selection=Gpu_selection,pooling="max",TPC=True)
