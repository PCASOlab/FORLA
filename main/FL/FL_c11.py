...
import pathlib
import argparse
from main.FL.FL_client import Fed_iter,ClientFedHelper,use_fedprox,mu,COMPONENTS_avg,Output_root
# Output_root = Output_root + "FL/Dino/"
Gpu_selection ='1'

CLIENT_ID = 11
DEFAULT_CONFIG = "videosaur_m/configs/videosaur/ytvis3_MLP786256.yml"
DEFAULT_CONFIG_s = "videosaur_m/configs/videosaur/ytvis3_MLP786256.yml"
...
# <<<<<<< HEAD
# Model_infer = model_infer_slot_att._Model_infer(parser.parse_args(),parser_s.parse_args(),GPU_mode,num_gpus,slot_ini="random",Foundation_M="ensemble",foundation_list  = [ "MAE" ],fusion_method='moe_layer',gpu_selection=Gpu_selection,pooling="max",TPC=True)
# =======
Model_infer = model_infer_slot_att._Model_infer(parser.parse_args(),parser_s.parse_args(),GPU_mode,num_gpus,slot_ini="random",Foundation_M="ensemble",foundation_list  = [ "DINO" ],fusion_method='moe_layer',gpu_selection=Gpu_selection,pooling="max",TPC=True)
# >>>>>>> main
