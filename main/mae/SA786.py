...
Model_infer = model_infer_slot_att._Model_infer(parser.parse_args(),GPU_mode,num_gpus,slot_ini="random",Foundation_M="MAE",gpu_selection=Gpu_selection,pooling="max",TPC=True)
